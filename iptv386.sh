...
echo 本脚本只适用于merlin 386.X改版固件，其他固件请勿运行本脚本
ping 127.0.0.1 -c 2 > /dev/null
...
#下载开机运行脚本
echo 正在下载新文件
wget -q --no-check-certificate https://raw.githubusercontent.com/lzk800/SH-4K-IPTV-Merlin/master/iptv-start
#设置权限
chmod -R 0755 iptv-start
#完成提示
echo 成功
...
echo 正添加IPTV运行脚本
#移动到脚本目录
cd /jffs/configs/dnsmasq.add
#删除旧配置文件
echo 正在删除旧文件
rm -rf iptv.conf
#下载新配置文件
echo 正在下载新文件
wget -q --no-check-certificate https://raw.githubusercontent.com/lzk800/SH-4K-IPTV-Merlin/master/iptv.conf
#设置权限
